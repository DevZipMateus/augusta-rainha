        ...
        <div className="text-center animate-on-scroll relative">
          ...
          <div className="bg-primary rounded-3xl p-12 md:p-16 max-w-4xl mx-auto text-white relative overflow-hidden">
            ...
            <Link to="/catalogo">
              <Button
                size="lg"
                className="bg-white hover:bg-white/90 text-primary px-12 py-6 text-xl md:text-2xl rounded-full font-bold shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-[pulse_12s_ease-in-out_infinite]"
              >
